...
determining earthquake magnitudes and recurrence rates is presented in Section \sref{sec:magnitude_selection}. This is followed by a
description of the method for generating realistic synthetic ruptures in source zones and on fault zones in Section \sref{sec:areal_gen} and 
\sref{sec:fault_gen}. Lastly, Section \sref{sec:source-scen} describes the approach for scenario event generation.
...
Figures \fref{fig:source-catalogue-results1}a to \fref{fig:source-catalogue-results4}a
...
Figures \fref{fig:source-catalogue-results1}c to \fref{fig:source-catalogue-results4}c.
