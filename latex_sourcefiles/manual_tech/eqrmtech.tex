...
\include{eqrmtech-intro}
\include{eqrmtech-hv-application}
\include{eqrmtech-h-source}
\include{eqrmtech-h-attn}
\include{eqrmtech-h-regolith}
\include{eqrmtech-v-damage}
\include{eqrmtech-v-losses}
\include{eqrmtech-v-vulnerability}
\include{eqrmtech-v-risk}

\appendix
\include{eqrmtech-apps}

\small
\bibliography{garefs,drrefs,EQRM_refs}
