...
or the CSM (\typepar{csm\_}{variability\_}{method}$=2$).\\
\hline
%---------------------------------------------------------
 \end{tabular}
...
Method used to incorporate variability in capacity curve\index{capacity curve}: \\
 \hspace{0.5em} None $\Rightarrow$ No sampling; \\
 \hspace{0.5em} 2 $\Rightarrow$ Random sampling applied to the building 
 parameters that define the \\
 \hspace{2.5em} capacity curve: \\
 \hspace{2.5em} $C_s$, $T_e$, $\alpha_1$, $\alpha_2$, $\gamma$, $\lambda$ and 
 $\mu$ (see section~\ref{sec:v-dam-capspect-capcurve} on 
 page~\pageref{sec:v-dam-capspect-capcurve}); \\
 \hspace{0.5em} 3 $\Rightarrow$ $+2\sigma$; \\
 \hspace{0.5em} 4 $\Rightarrow$ $+\sigma$; \\
 \hspace{0.5em} 5 $\Rightarrow$ $-\sigma$; \\
 \hspace{0.5em} 6 $\Rightarrow$ $-2\sigma$.\\
