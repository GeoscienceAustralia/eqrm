...
\typeoutput{<site\_loc>}{\_SA}{\_rp[return\_period].txt}. It is important to
...
\includegraphics{demo_hazard_exceedance}
...
\typeoutput{<site\_loc>}{\_total\_building\_loss.txt}{} along with
...
\typeoutput{<site\_loc>}{\_total\_building\_loss.txt}{} file is processed
...
\includegraphics{demo_loss_exceedance}
...
\includegraphics{demo_annloss_deagg_distmag}
...
stored in the file
\typeoutput{<output\_dir>}{}{} directory. 
\begin{figure}
%\includegraphics{fig-risk-scen-hist}
\includegraphics{demo_scenario_building_loss_percent}
