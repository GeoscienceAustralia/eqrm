...
class Ground_motion_calculator(object):
    ...
    def resize_mag_depth(self, mag, depth):
        """
...
class Multiple_ground_motion_calculator(object):
    ...
    def distribution(self,
        ...
        if sites.attributes.has_key('VS30'):
            vs30 = sites.attributes['VS30']
        else:
            vs30 = None
        ...
        self.log_normal_distribution.set_log_mean_log_sigma_etc(
            *results)
    ...
    def _distribution_function(self, dist_object, mag_dict, depth=None
        ...
        for attenuation_id, GM_model in enumerate(self.GM_models):
            log_mean,log_sigma = GM_model.distribution_function(
                dist_object, mag_dict, depth=depth,
                vs30=vs30,
