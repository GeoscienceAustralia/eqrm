...
"""
    ...
    def test_Obsolete_Event_Activity(self):
        num_events = 3
        ea = Obsolete_Event_Activity(num_events)
    ...
    def test_Obsolete_Event_Activity_set_event_activity(self):
        num_events = 3
        ea = Obsolete_Event_Activity(num_events)
    ...
    def test_Obsolete_Event_Activity2(self):      
        num_events = 5
        max_weights = 5
        ea = Obsolete_Event_Activity(num_events, max_weights)
        indexes = arange(5)
        activity = indexes*10
    ...
    def test_Obsolete_Event_Activity3(self):
           
        num_events = 5
        max_num_models = 5
        ea = Obsolete_Event_Activity(num_events, max_num_models)
