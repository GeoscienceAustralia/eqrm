...
CONV_NEW = [{'order': 10.0,
            ...
            {'old_para': 'var_bcap_flag',
             'values': {None: None,
                        ...
                        0: False},
             'order': 80.01,
             'new_para': 'csm_damage_state_use_variability',
             'default': True,
             'run_type': ['risk_csm']},
            ...
            {'old_para': 'stdcap',
             'order': 80.03,
             'new_para': 'csm_damage_state_standard_deviation',
             'default': 0.3,
             'run_type': ['risk_csm']},
            {'order': 80.04,
...
DEPRECATED_PARAS = {
    ...
    'csm_standard_deviation':               'csm_damage_state_standard_deviation',
    'csm_use_variability':                  'csm_damage_state_use_variability'
    }
