...
# Note: values in cm/sec**2
# Mw=6.0, Rrup=100.0, Depth=5.0
test_data['Allen_2012_test_accelM60R100D5'] = array([[0.0100,    14.3124],
                                                     [0.0200,    17.9941],
                                                     [0.0300,    18.9298],
                                                     [0.0500,    19.9861],
                                                     [0.0750,    22.0776],
...
test_data['Allen_2012_test_accelM40R100D5'] = array([[0.0100,    0.4299],
                                                     [0.0200,    0.5264],
                                                     [0.0300,    0.6953],
                                                     [0.0500,    0.8875],
                                                     [0.0750,    1.0032],
...
test_data['Allen_2012_test_accelM35R100D10'] = array([[0.0100,    0.1535],
                                                      [0.0200,    0.3171],
                                                      [0.0300,    0.3510],
                                                      [0.0500,    0.3526],
                                                      [0.0750,    0.3275],
...
# Mw=3.5, Rrup=10.0, Depth=10.0
test_data['Allen_2012_test_accelM35R10D10'] = array([[0.0100,    11.4964],
                                                     [0.0200,    25.1172],
                                                     [0.0300,    29.9368],
                                                     [0.0500,    26.8350],
                                                     [0.0750,    22.5126],
...
test_data['Allen_2012_test_accelM40R10D10'] = array([[0.0100,    29.7504],
                                                     [0.0200,    53.5399],
                                                     [0.0300,    64.7634],
                                                     [0.0500,    62.6412],
                                                     [0.0750,    56.5558],
...
test_data['Allen_2012_test_accelM60R10D5'] = array([[0.0100,    363.8970],
                                                    [0.0200,    517.3992],
                                                    [0.0300,    538.4845],
                                                    [0.0500,    548.9900],
                                                    [0.0750,    557.5967],
...
test_data['Allen_2012_test_accelM60R100D10'] = array([[0.0100,    15.9544],
                                                      [0.0200,    18.8207],
                                                      [0.0300,    20.6664],
                                                      [0.0500,    24.1480],
                                                      [0.0750,    27.7559],
...
test_data['Allen_2012_test_accelM60R10D10'] = array([[0.0100,    427.1470],
                                                     [0.0200,    532.5117],
                                                     [0.0300,    616.1882],
                                                     [0.0500,    679.0518],
                                                     [0.0750,    706.0762],
...
test_data['Allen_2012_test_accelM40R10D5'] = array([[0.0100,    25.8404],
                                                    [0.0200,    38.7281],
                                                    [0.0300,    45.4634],
                                                    [0.0500,    55.1820],
                                                    [0.0750,    55.3045],
...
test_data['Allen_2012_test_accelM40R100D10'] = array([[0.0100,    0.4808],
                                                      [0.0200,    0.8185],
                                                      [0.0300,    0.9233],
                                                      [0.0500,    0.9931],
                                                      [0.0750,    0.9956],
...
test_data['Allen_2012_test_accelM35R10D5'] = array([[0.0100,     8.9584],
                                                    [0.0200,    13.2501],
                                                    [0.0300,    16.7806],
                                                    [0.0500,    22.3877],
                                                    [0.0750,    22.4644],
...
test_data['Allen_2012_test_accelM35R100D5'] = array([[0.0100,    0.1203],
                                                     [0.0200,    0.1428],
                                                     [0.0300,    0.2109],
                                                     [0.0500,    0.2966],
                                                     [0.0750,    0.3376],
...
test_data['Allen_2012_test_sigma_shallow'] = array([[0.41690222,
                                                     0.44074042,
                                                     0.43462458,
                                                     0.4082034 ,
                                                     0.39320546,
...
test_data['Allen_2012_test_sigma_deep'] = array([[0.39517826,
                                                  0.41887798,
                                                  0.41307747,
                                                  0.38677752,
                                                  0.37283443,
