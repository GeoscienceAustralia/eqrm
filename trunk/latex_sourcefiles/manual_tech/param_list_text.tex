...
A list of the ground motion models (or GMPEs) to be used. Current choices are; \\
 ...
 \hspace{0.5em} \texttt{`Sommerville09\_Yilgarn'} $\Rightarrow$ Sommerville (2009) Yilgarn Craton; \\
  \hspace{0.5em} \texttt{`Sommerville09\_Non\_Cratonic'} $\Rightarrow$ Sommerville (2009) Average Non Cratonic \\
  \hspace{14.5em}  model. \\
%---------------------------------------------------------
