...
Extra tag for specifying a unique source zone file. The
filename for the source zone is
\texttt{<site\_tag>\_}\texttt{fault\_source\_}\texttt{<zone\_source\_tag>}\texttt{.xml}
\\
%---------------------------------------------------------
\hline \vspace{0.1em} \texttt{fault\_source\_tag}: \\
Extra tag for specifying a unique source fault file. The
...
Extra tag for specifying a unique event control file. The
...
DEFAULT $=$ \texttt{False} \\
SUGGESTED $=$ 1 (PSHA), 2 (PSRA) or 3 to 6 (Scenario) 
