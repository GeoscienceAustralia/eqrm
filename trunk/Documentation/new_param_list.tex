...
\begin{supertabular}{lp{0.6\textwidth}}
\typepar{determ\_azimth}{}{}  &   Azimuth of the deterministic event.   \\
\typepar{det}{erm}{\_latitude}  &  Latitude of rupture centroid \\
\typepar{det}{erm}{\_longitude}  &  Longitude of rupture centroid    \\
\typepar{det}{erm}{\_magnitude}  &  Moment magnitude of event    \\
\typepar{det}{erm}{\_depth}  &  Depth to event     \\
\typepar{det}{erm}{\_dip} &    Dip of event.  \\
\typepar{det}{erm}{\_number\_of\_events} & The desired number of
...
\typepar{prob}{\_delta\_azimuth}{\_in\_zones}   &   Azimuth range for events (i.e. \texttt{azimuth} $\pm$ \typepar{delta}{\_a}{zimuth}). Note that this can be a single value (used in all source zones) or a list with different elements for each source zone.  \\
...
\typepar{atten\_use\_variability}{}{}   &   If \texttt{True} use the
...
\typepar{atten\_rescale\_curve\_from\_pga}{}{}  &  \\
...
\typepar{atten\_pga\_scaling\_cutoff}{}{}   & The PGA cutoff for re-scaling $S_a$.      \\
...
\typepar{amp\_use\_variability}{}{}    &  If \texttt{True} use the
variability method described below. \\
...
\typepar{csm\_damping\_use\_smoothing}{}{}  & Smoothing of damped curve: \\
 ...
 \typepar{csm\_use\_hysteretic\_damping}{}{}   & If \texttt{True} use the
...
\begin{supertabular}{lp{0.6\textwidth}}
 \typepar{site}{\_}{tag}    &   String used in input and output file
...
\typepar{site\_indexes}{}{} & List whose elements represent the site
 ...
 \typepar{site}{\_db\_}{tag}    &   String used specify the structure
...
\typepar{return\_periods}{}{}  &   List whose elements represent the return periods to be considered for hazard. \\
  \typepar{inp}{ut}{\_dir} &  Directory containing any local input files.\\
