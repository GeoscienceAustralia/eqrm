"""
 ...
 Scenario - set a atten_threshold_distance so low that no events are applicable
            to the site_indexes
"""
...
output_dir = join('.', 'implementation_tests', 'current', 'TS_haz40')
