...
% faultmatmain = [-118.465	34.394	3.000 
%                 -118.275	34.337	3.000 
%                 -118.240	34.416	15.944
%                 -118.430	34.473	15.944
%                 -118.465	34.394	3.000
%                 NaN NaN NaN                       
%                 -118.463	34.388	0.000 
%                 -118.277	34.347	0.000 
%                 -118.254	34.416	7.990 
%                 -118.441	34.457	7.990 
%                 -118.463	34.388	0.000];
...
%     disp(mindist)
    ...
    % iterate around fault to find shortest distance
    tmpdist1 = 9999999;
...
%         topInd = topInd(1);
        ...
        %% get dist along fault from top edge
        if top2botdist ~= 0
