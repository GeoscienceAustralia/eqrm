...
Defines the operation mode of the EQRM: \\
  ...
  \hspace{0.5em} `fatality' $\Rightarrow$ To be completed; \\
  \hspace{0.5em} `bridge' $\Rightarrow$ To be completed. \\
%---------------------------------------------------------
 \hline
...
\\
Supported \texttt{run\_type} $=$ `risk' \\
%---------------------------------------------------------
...
\\
Supported \texttt{run\_type} $=$ `risk', `bridge' \\
%---------------------------------------------------------
\hline \vspace{0.1em} \texttt{save\_fatalities}: \\
DEFAULT = \texttt{False} \\
\texttt{True} $\Rightarrow$ To be completed. \\ 
\\
Supported \texttt{run\_type} $=$ `risk', `bridge' \\
\hline
%---------------------------------------------------------
