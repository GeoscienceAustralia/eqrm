...
output_dir = join('.', 'implementation_tests', 'current', 'TS_risk59')
...
# Attenuation
atten_models = ['Boore_08']
atten_model_weights = [1]
atten_collapse_Sa_of_atten_models = True
atten_variability_method = None
atten_periods = [0.0, 0.17544000000000001, 0.35088000000000003, 0.52632000000000001, 0.70174999999999998, 0.87719000000000003, 1.0526, 1.2281, 1.4035, 1.5789, 1.7544, 1.9298]
...
csm_damage_state_use_variability = False
csm_damage_state_standard_deviation = 0.3
